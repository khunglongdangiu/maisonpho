...
export default function MichelinStarClientPage() {
  const { t } = useLanguage()
        ...
        <section className="bg-muted py-16">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">{t("news.1.title")}</h1>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg">{t("news.1.content.p1")}</p>
                <p>{t("news.1.content.p2")}</p>
                <p>{t("news.1.content.p3")}</p>
                <p>{t("news.1.content.p4")}</p>
              </div>
